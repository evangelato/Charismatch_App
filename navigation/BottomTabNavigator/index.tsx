...
import { PersonIcon, ActivityIcon, MessageIcon, SettingsIcon } from '../../assets/icons';
...
const BottomTabNavigator: React.FC = () => {
  return (
    ...
    >
      <BottomTab.Screen name={Routes.PROFILE} component={Profile} options={{ tabBarIcon: PersonIcon }} />
